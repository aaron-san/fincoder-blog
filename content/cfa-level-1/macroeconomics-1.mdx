...
<Math>
  {
    "$E_{p} = \\frac{\\Delta \\text{Quantity demanded}} {Delta Price} = \\frac {\\Delta Q_{d} \\div Q_{ave}} {\\Delta P \\div {P_{ave}}}$"
  }
</Math>
...
<Math>
  {
    "$E_{c} = \\frac{\\Delta \\text{Quantity demanded}} {\\Delta \\text{Price of substitute or complement}}$"
  }
</Math>
...
<Math>
  {"$E\\_{i} = \\frac{\\Delta \\text{Quantity Demanded}} { \\Delta Income}$"}
</Math>
...
<Math>
  {
    "$E*{p} = \\frac{\\Delta Quantity Supplied} {\\Delta Price} = \\frac{\\Delta Q*{s} \\div Q*{ave}} {\\Delta P \\div {P*{ave}}}$"
  }
</Math>
