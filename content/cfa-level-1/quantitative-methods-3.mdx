...
<Math>
  {
    "$\\frac{n!} {n_1! \\space \\cdot \\space n_2! \\space \\cdot \\space ... \\space \\cdot \\space n_k!}$"
  }
</Math>
...
<Math>
  {
    "$t = \\frac{ (x_1 - x_2) - (\\mu_1 - \\mu_2) } {\\sqrt{\\left( \\frac{s_p^2}{n_1}+\\frac{s_p^2}{n_2} \\right)} }$"
  }
</Math>
...
<Math>
  {
    "$t = \\frac{ (x_1 - x_2) - (\\mu_1 - \\mu_2) } {\\sqrt{\\left( \\frac{s_1^2}{n_1}+\\frac{s_2^2}{n_2} \\right)} }$"
  }
</Math>
...
<Math>{"$t = \\frac{ \\bar d - d_{zs} } { s_{\\bar d} / \\sqrt n }$"}</Math>
